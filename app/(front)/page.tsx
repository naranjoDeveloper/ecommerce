...
export const metadata: Metadata = {
  title: process.env.NEXT_PUBLIC_APP_NAME || 'Ecommerce Naranjo',
  description: process.env.NEXT_PUBLIC_APP_DESC || 'Nextjs Ecommerce Naranjo',
}
...
export default async function Home() {
  ...
  return (
    <>
      ...
      <h2 className="text-2xl py-2">Ultimos Lanzamientos</h2>
